...
### 1. JPA이란?
 ...
 - JDBC API를 사용하지 않고 JPA를 쓰는 이유
    ...
    ※ ORM에 대해서는 <b>"[ORM이란?](https://github.com/hongcoding94/JPA_storage/blob/main/JPA_%EC%9D%B4%EB%A1%A0/JPA_%EC%A0%95%EB%A6%AC/002.%20ORM%EC%9D%B4%EB%9E%80%3F.md)"</b>를 참조
